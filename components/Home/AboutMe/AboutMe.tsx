            ...
            <div className="w-full md:w-7/12 space-y-4">
              <div className="font-Header tracking-wider">
                <span className="text-gray-400  ">
                  Hi! I&apos;m currently learning game dev and{" "}
                  <span className="text-AAsecondary">Ethical Hacking</span> two
                  worlds I&apos;m super hyped about. I love building stuff and
                  breaking it (ethically, of course....).
                </span>
              </div>
              <div className="font-Header tracking-wider">
                <span className="text-gray-400  ">
                  I&apos;m also a college student looking for real-world
                  experience.
                  <br /> Always up for projects, collabs, or anything that helps
                  me grow and have fun!
                </span>
              </div>
              <div className="font-Header tracking-wider">
